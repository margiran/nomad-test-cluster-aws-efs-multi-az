...
# This IAM role/code is being copied from the following repo https://github.com/hashicorp/terraform-aws-nomad-starter/blob/master/modules/nomad_cluster/iam.tf
